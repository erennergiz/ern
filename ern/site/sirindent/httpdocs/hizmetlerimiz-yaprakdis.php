...
<div class="mainwrapper">
    <div class="ic_link"><a href="index.php?sayfa=anasayfa">Anasayfa</a> / <a href="index.php?sayfa=hizmetlerimiz">Hizmetlerimiz</a> / <a
            href="index.php?sayfa=hizmetler-yaprakdis">Yaprak Diş</a></div>
    <div id="koli">

        <div class="sol_blog">
            <div class="sol_blog_resim"><img src="_uploads/photos/hizmetler/yaprakdis-sirindet.jpg" alt="" width="195" height="200"/></div>
            <div class="sol_blog_resim_cerceve"></div>
            <div class="sol_blog_text">Yaprak Diş</div>
        ...
        <div class="sag_blog">
           ...
           <font style=" font-weight: bold;">Porselen Yapraklar (Laminate Veneer)</font><br /><br />
<p>
	Gülümsediğinizde ön dişlerdeki bir takım bozukluklar estetik açıdan sizi rahatsız ediyorsa, rahatlıkla tercih edebileceğiniz bir tedavi yöntemidir. Size doğal bir güzellik kazandıran,sağlam ve renkleri bozulmayan laminalardır.Dişlerin sadece ön yüzeyinden çok az aşındırma yapılarak,yaprak şeklinde porselenler diş yüzeyine yapıştırılır.Bu yaprakların kalınlığı 0,3-0,5mm kadardır.Hastanın yüzüne en uygun şekilde istenilen renkte ve boyda hazırlanabilir.Dişlere yapılan en koruyucu tedavilerden biridir.Dişlerin tamamen küçültülüp üzerine kuron yapılmasına gerek kalmaz.Sadece porselen olduğu ve metal içermediği için ışık geçirgenliği çok iyidir.Bu yüzden estetik olarak görünümleri de &nbsp;çok iyidir.Tedavi süreci kısadır.Hastanın dişlerine hiç bir işlem yapmadan önce ölçü alınır.Bir alçı model hazırlanır ve bu model üzerinde dişler çalışılarak,bitince nasıl görüneceği konusunda hasta bilgilendirilmiş olur.Daha sonra dişlerde çok az aşındırma yapılarak geçici plastik veneer dişler yapıştırılır.Porselen veneer dişler çok ince olmalarına rağmen yapıştırıldıklarında çok dayanıklıdırlar dişten tekrar ayırmak mümkün değildir sadece aşındırılarak çıkarılabilirler. Çay, kahve,sigara....v.s etkisiyle boyanma ve renkleşme oluşmaz.</p><br />
<p>
	<font style=" font-weight: bold;">Laminate Veneerin Uygulandığı Durumlar</font><br /><br />
<ul>
	<li>
		Renkleşmiş, lekelenmiş dişler.</li>
	<li>
		Aralıklı dişler.</li>
	<li>
		Aşınmış, kırık dişler.</li>
	<li>
		Şekil bozukluğu, çapraşıklık olan dişler.</li>
	<li>
		Yaş nedeniyle boyu kısalmış, aşınmış, çatlamış dişler.</li>
	<li>
		Rengi ve yapısı bozulmuş eski dolgular.</li>
	<li>
		Diş beyazlatma ile sonuç alınamayan dişler.</li>
</ul>
<p>&nbsp;
	</p>
<p>
	Çene kapanış bozuklukları, tırnak yeme, kalem ısırma, diş gıcırdatma, ileri derecede diş eti problemleri, çekilmeleri olanlarda uygulanmaz hassas bir teknik gerektirir bu yüzden biraz daha pahalıdır.</p>
