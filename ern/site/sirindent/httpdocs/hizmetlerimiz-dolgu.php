...
<div class="mainwrapper">
    <div class="ic_link"><a href="index.php?sayfa=anasayfa">Anasayfa</a> / <a href="index.php?sayfa=hizmetlerimiz">Hizmetlerimiz</a> / <a
            href="index.php?sayfa=hizmetler-implantlar">Dolgu</a></div>
    <div id="koli">

        <div class="sol_blog">
            <div class="sol_blog_resim"><img src="_uploads/photos/hizmetler/dolgu-zirkonyum.jpg" alt="" width="195" height="200"/></div>
            <div class="sol_blog_resim_cerceve"></div>
            <div class="sol_blog_text">Dolgu</div>
        ...
        <div class="sag_blog">
            ...
            <p>
	Dişlerin eksik kısımlarını birtakım malzemeler ile tamamlamaktır.Dişlerdeki bu eksiklikler çürük veya kırık nedeni ile olaşabilir.Dolgunun faydası bakterilerin girebileceği boşlukları kapatarak çürüğün ilerlemesini engellemektir.Diş çürükleri daha çok koyu renklenmelerle birlikte görülen oyuklardır.Ağızda bulunan bakterilerden oluşan bakteri plağı şekerli yiyeceklerin ağızda kalan artıklarından asit oluşturur.Bu asitler dişlerin mineral dokusunu çözerek, diş çürüğünün başlamasına ve &nbsp;ilerleyerek (kavite) denen oyuklara neden olur.</p><br />
<p style=" font-weight:bold;">Dolgu Nasıl Yapılır ?</p><br />
<p>
	Çürük olan diş temizlenir. Bir kavite (oyuk) hazırlanır ve dolgu dişe yerleştirilerek dişe çürümeden önceki fonksiyonu ve doğal şekli verilmeye çalışılır.</p><br />
<p style=" font-weight:bold;">Amalgam Dolgu</p><br />
<p>
	İçinde gümüş kalay az miktarda bakır ve çinko içeren tozlar ile civanın karıştırılmasıyla hazırlanır. Bilimsel araştırmalar amalgam dolgunun zararsız olduğu sonucuna varmıştır. Dişlerdeki çiğnemeye bağlı cıva açığa çıktığı bilinse &nbsp;de bunun çevreden alınan cıvadan çok daha düşük olduğu söylenmektedir. Amalgamlar söküldüğünde civanın oluşturduğu düşünülen bazı hastalıkların iyileştiği iddia edildiği halde bilimsel olarak ispatlanamamıştır. Estetik değil fakat dayanıklıdır. Basınca dayanıklılığı iyi olduğu için arka azı dişlerinde tercih edilen dolgudur. Ekonomiktir ve yaklaşık 150 yıldan beri kullanılmaktadır. Uygulaması kolaydır ve diğer dolgulara oranla daha kısa sürede dişe yerleştirilir.</p><br />
<p style=" font-weight:bold;">Kompozit Dolgular</p><br />
<p>
	Diş renginde dolgulardır. Önceleri sadece ön dişlerde kullanılırken günümüzde materyaller ileri derecede geliştirilerek çiğneme basıncına dayanıklı ve daha az aşınan kompozitler de bulunmaktadır. Kompozit dolgular dişlere tabaka tabaka yerleştirilerek &nbsp;her defasında ışıkla sertleştirilir.</p><br />
<p style=" font-weight:bold;">Porselen Dolgular</p><br />

<p>
	Laboratuarda kişiye, dişe özel hazırlanır. Dişlerde çok çürük ,kırık defekti varsa bu dolgular tercih edilir.Biraz daha zahmetli ,maliyetli ve işlemi uzun dolgulardır.Teorik olarak her çürüğe dolgu yapılabilir fakat dolguyu tutamayacak kadar dişte defekt varsa onun yerine kuron (kaplama) tercih edilebilir…Yada çürük sinire ulaşmışsa önce kanal tedavisi yapılıp sonra dolgu yapılır.Dolgunun yapılması bir daha o dişin asla çürümeyeceği anlamına gelmez.Kişi dolgudan sonra ağız bakımına dikkat etmezse dolgulu diş ,kenarında yada başka bir yerinden çürüyebilir.Metal dolguların ömürleri daha uzundur.20 yıl kadar Kompozitlerin ömrü 7-10 yıl kadardır, fakat kişinin ağız bakımı düzenli doktor kontrolü ,dişindeki defektin şekli,ısırma alışkanlıkları bu süreleri etkilemektedir.Dolgularda 6 ayda bir kontrol yapılmalıdır.Dolguda sızıntı,renkleşme,kararma,kırık,çatlak,gevşeme varsa değiştirilmesi gerekir.Dolgular düşerse hemen diş hekimine başvurmak gerekir,aksi taktirde açık kalan&nbsp; dişte kırılma,sızlama, uzun süreli açık kalmalarda dişte çürüme ilerleyerek iltihaba ve ağrıya&nbsp; sebep olur.Kanal tedavisi gerekebilir yada diş tamamen kaybedilir.</p>
