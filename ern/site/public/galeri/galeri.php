        ...
        height: 420px;">
            ...
            overflow: hidden;">
                ...
                <div>
                    ...
                    <img u="thumb" src="../img/landscape/thumb-02.jpg" />
                </div>
                <div>
                    <img u="image" src="../img/landscape/03.jpg" />
                    <img u="thumb" src="../img/landscape/thumb-03.jpg" />
                </div>
                <div>
                    <img u="image" src="../img/landscape/04.jpg" />
                    <img u="thumb" src="../img/landscape/thumb-04.jpg" />
                </div>
                <div>
                    <img u="image" src="../img/landscape/05.jpg" />
                    <img u="thumb" src="../img/landscape/thumb-05.jpg" />
                </div>
                <div>
                    <img u="image" src="../img/landscape/06.jpg" />
                    <img u="thumb" src="../img/landscape/thumb-06.jpg" />
                </div>
                <div>
                    <img u="image" src="../img/landscape/07.jpg" />
                    <img u="thumb" src="../img/landscape/thumb-07.jpg" />
                </div>
            </div>
...
<div id="footer_index">
    <div class="mainwrapper_fo">
        <div>
            <div class="sizden">
                <a href="sizden-gelenler.html"><img src="<?php echo SITE_PUBLIC; ?>img/content/index/sizden-gelenler.png" alt="" width="320"
                                                    height="160"/></a>
            </div>
            <div class="blogla">
                <a href="blog.html"><img src="<?php echo SITE_PUBLIC; ?>img/content/index/blog.png" alt="" width="320" height="160"/></a>
            </div>
            <div class="sorular">
                <a href="sorular.html"><img src="<?php echo SITE_PUBLIC; ?>img/content/index/sorular.png" alt="" width="320"
                                            height="160"/></a>
            </div>
        </div>
    </div>
