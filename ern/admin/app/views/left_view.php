...
<div id="content">
		<div id="sidebar">
			<div class="box">
                                    <div class="h_title">&#8250; Kısayollar</div>
				<ul id="home">
					<li class="b1"><a class="icon view_page" target="_blank" href="<?php echo SITE_URL_SITE; ?>">Siteyi Görüntüle</a></li>
					<li class="b2"><a class="icon report" href="">Raporlar</a></li>
					<li class="b1"><a class="icon add_page" href="<?php echo SITE_URL; ?>/panel/addnewcontent">Yeni İçerik Ekle</a></li>
					<li class="b2"><a class="icon config" href="">Site Ayarları</a></li>
				</ul>
			</div>
			
			<div class="box">
				<div class="h_title">&#8250; İçerik Yönetimi</div>
				<ul>
					<li class="b1"><a class="icon page" href="">Tüm İçerikler</a></li>
					<li class="b2"><a class="icon add_page" href="">Yeni İçerik Ekle</a></li>
                    <li class="b1"><a class="icon config" href="sliderDuzenle">Slider Düzenle</a></li>
			...
			<div class="box">
				...
				<ul>
					<li class="b1"><a class="icon config" href="">Site Ayarları</a></li>
					<li class="b2"><a class="icon contact" href="">İletişim Mesajları</a></li>
				</ul>
			</div>
		</div>